...
public:
	...
	*/
	AirportServer()
	{
		...
		lock4L = unique_lock<mutex>(rw_4L);
		lock4R = unique_lock<mutex>(rw_4R);
		lock15L = unique_lock<mutex>(rw_15L);
		lock15R = unique_lock<mutex>(rw_15R);
		lock9 = unique_lock<mutex>(rw_9);
		lock14 = unique_lock<mutex>(rw_14);
...
private:
	...
	*/
	...
	unique_lock<mutex> lock4L;
	unique_lock<mutex> lock4R;
	unique_lock<mutex> lock15L;
	unique_lock<mutex> lock15R;
	unique_lock<mutex> lock9;
	unique_lock<mutex> lock14;
